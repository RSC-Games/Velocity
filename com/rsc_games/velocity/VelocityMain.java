...
import com.rsc_games.velocity.system.FileResourceLoader;
import com.rsc_games.velocity.system.JARResourceLoader;
...
import com.rsc_games.velocity.util.Version;
...
public class VelocityMain implements Driver {
    ...
    public static void app_main(GlobalAppConfig bcfg, GlobalSceneDefs sceneDefs) {
        ...
        Scene.setGlobalSceneLUT(sceneDefs);
