package com.rsc_games.velocity.config;
...
public class GlobalAppConfig {
     ...
     * 
     * @deprecated since VXRA is being removed there's no reason to select renderers.
     */
     ...
     * @deprecated ERP is being removed in its entirety.
     */
    @Deprecated(since="0.7.0.0", forRemoval=true)
